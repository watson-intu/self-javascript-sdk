...
var Conversation = (function() {
  ...
  function buildMessageDomElement(text, isUser, image_url) {
    ...
    var content = [];
    if(isUser) content += '<img src=\'head.svg\' />';
    content += {
      'tagName': 'p',
      'html': text
    };
    if(!isUser) content += '<img src=\'watson-logo-round.png\' />';
    ...
    var messageJson = {
      ...
      'children': [{
        ...
        // 'children': content
        'html': (isUser ? '<img src=\'head.svg\' />' + text : img_msg + '<img src=\'watson-logo-round.png\' />')
      }]
    };
  ...
  function updateChat() {
    ...
    document.body.scrollTop = messages[messages.length - 1].offsetTop;
  }
